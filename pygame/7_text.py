...
# 배경 이미지 불러오기
background = pygame.image.load("/Users/HumanRevolution/jupytercreation/pygame_basic/background.png")

# 케릭터(스프라이트) 불러오기
character = pygame.image.load("/Users/HumanRevolution/jupytercreation/pygame_basic/character.png")
...
# 적(enemy) 케릭터
enemy = pygame.image.load("/Users/HumanRevolution/jupytercreation/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size  # 이미지 크기 구해서 반환
